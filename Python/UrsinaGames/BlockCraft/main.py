...
punch_sound = Audio('Audio/punch_sound.wav', loop=False, autoplay=False)

sky_texture = load_texture('Textures/skybox.png')
arm_texture = load_texture('Textures/arm_texture.png')
grass_texture = load_texture('Textures/Block/grass_block.png')
stone_texture = load_texture('Textures/Block/stone_block.png')
dirt_texture = load_texture('Textures/Block/dirt_block.png')
brick_texture = load_texture('Textures/Block/brick_block.png')
block_pick = 1
